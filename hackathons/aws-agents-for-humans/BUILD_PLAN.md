...
### Phase 1 — skeleton
- initialize isolated Strands project;
- define opportunity schema and deterministic ranker;
- add sample fixtures and tests.

### Phase 2 — agent workflow
- implement scout/verifier/filter/ranker/briefing pipeline;
- add retry/error handling and dedupe;
...
Planning only. No claim is made that the AWS implementation, deployment, or hackathon submission is complete.
